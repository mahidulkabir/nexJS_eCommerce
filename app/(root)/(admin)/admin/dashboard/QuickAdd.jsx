  ...
  return (
    <div className='grid lg:grid-cols-4 sm:grid-cols-2 sm:gap-10 gap-5 mt-10'>
      <Link href={ADMIN_CATEGORY_ADD}>
            <div className='flex items-center justify-between p-3 rounded-lg shadow bg-white dark:bg-gray-900 bg-gradient-to-tr from-green-400 via-green500 to-green-600'>
      ...
      <Link href={ADMIN_PRODUCT_ADD}>
            <div className='flex items-center justify-between p-3 rounded-lg shadow bg-white dark:bg-gray-900 bg-gradient-to-tr from-blue-400 via-blue500 to-blue-600'>
                <h4 className='font-medium text-white dark:text-black'>
                        Add Product
                </h4>
      ...
      <Link href={ADMIN_COUPON_ADD}>
            <div className='flex items-center justify-between p-3 rounded-lg shadow bg-white dark:bg-gray-900 bg-gradient-to-tr from-yellow-400 via-yellow500 to-yellow-600'>
                <h4 className='font-medium text-white dark:text-black'>
                        Add Coupon
                </h4>
      ...
      <Link href={ADMIN_MEDIA_SHOW}>
            <div className='flex items-center justify-between p-3 rounded-lg shadow bg-white dark:bg-gray-900 bg-gradient-to-tr from-cyan-400 via-cyan500 to-cyan-600'>
                <h4 className='font-medium text-white dark:text-black'>
                       Upload Media
                </h4>
